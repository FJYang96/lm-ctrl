...
mpc_config: MPCConfig = HoppingMPCConfig(
    duration=duration,
    mpc_dt=0.02,
    pre_flight_stance_duration=0.4,  # Used for finding contact sequence
    flight_duration=0.15,  # Used for finding contact sequence
    ...
    path_constraints=[
        ...
        # constr.torque_limits_constraints,
    ],
