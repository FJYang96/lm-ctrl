# Adapted from https://github.com/iit-DLSLab/Quadruped-PyMPC/blob/main/quadruped_pympc/controllers/gradient/kinodynamic/kinodynamic_model.py
# to expose the selection of config
