...
def generate_constraints(
    ...
    *,
    ...
    lines.append(
        ...
        "You decide the strategy: tweak or pivot but some helpful guidance on when. "
        "If the solver is failing for 2+ iterations or scores are plateauing for 3+ iterations, pivot "
        "structurally and start the new structure with wide bounds. "
        "If converging and improving, tighten. "
        "Always keep at least one constraint for the primary motion "
        "variable and one for height/stability. "
